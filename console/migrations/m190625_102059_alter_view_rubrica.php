...
/**
 * Class m190625_102059_alter_view_rubrica
 */
class m190625_102059_alter_view_rubrica extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        Yii::$app->db->createCommand("
            ...
            FROM (
                ...
                CASE WHEN str_tipo_struttura.descrizione ilike 'comunita'' montana' THEN 'comunita'' montana'::text
                     ELSE 'struttura'::text
               ...
               FROM con_struttura_contatto
                ...
                utl_contatto.type AS tipo_contatto,
                CASE WHEN ent_tipo_ente.descrizione ilike 'comune' THEN 'comune'::text
                     WHEN ent_tipo_ente.descrizione ilike 'prefettura' THEN 'prefettura'::text
                     ELSE 'ente'::text
                END as tipologia_riferimento,
    ...
    t.provincia,
    t.vendor,
    concat(t.tipologia_riferimento, '_', t.id_riferimento) AS identificativo,
    concat(con_view_rubrica_everbridge_ext_ids.ext_id) AS ext_id,
    concat(con_view_rubrica_everbridge_ext_ids.ext_id, '_', con_view_rubrica_everbridge_ext_ids.delivery_path) AS everbridge_identifier
   FROM (( SELECT DISTINCT ON (con_struttura_contatto.id) con_struttura_contatto.id_contatto,
    ...
    {
        echo "m190625_102059_alter_view_rubrica cannot be reverted.\n";
