...
/**
 * Class m190530_161750_alter_view_organizzazioni
 */
class m190530_161750_alter_view_organizzazioni extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        Yii::$app->db->createCommand("CREATE OR REPLACE VIEW view_organizzazioni as
            SELECT utl_automezzo.id AS ref_id,
              ...
              WHERE ((utl_automezzo.disponibilita = '1') AND (vol_organizzazione.stato_iscrizione = 3))
            UNION
    ...
    {
        echo "m190530_161750_alter_view_organizzazioni cannot be reverted.\n";
