...
/**
 * Class m210611_090548_alter_view_organizzazioni_capacita
 */
class m210611_090548_alter_view_organizzazioni_capacita extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        Yii::$app->db->createCommand("CREATE VIEW view_organizzazioni AS 
            SELECT utl_automezzo.id AS ref_id,
                ...
                utl_automezzo.capacita AS capacita,
            ...
            UNION
             SELECT utl_attrezzatura.id AS ref_id,
                ...
                utl_attrezzatura.capacita AS capacita,
                vol_sede.id AS id_sede,
                vol_sede.indirizzo AS indirizzo_sede,
                vol_sede.telefono AS telefono_sede,
                vol_sede.altro_telefono AS altro_telefono_sede,
    ...
    {
        echo "m210611_090548_alter_view_organizzazioni_capacita cannot be reverted.\n";
