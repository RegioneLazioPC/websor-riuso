...
/**
 * Class m181116_182222_sync_alter_data_for_inevitable_errors_cause_by_publishing_fluxes
 */
class m181116_182222_sync_alter_data_for_inevitable_errors_cause_by_publishing_fluxes extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        // mettiamo 3 per quelle già presenti
        VolOrganizzazione::updateAll(['stato_iscrizione' => 3], 'id_sync is null or id_sync = \'\'');
        UtlAutomezzo::updateAll(['disponibilita' => 1], 'id_sync is null or id_sync = \'\'');

        $this->addColumn("utl_attrezzatura","disponibilita",$this->integer()->defaultValue(0));
        UtlAttrezzatura::updateAll(['disponibilita' => 1], 'id_sync is null or id_sync = \'\'');
        ...
        Yii::$app->db->createCommand("CREATE VIEW view_organizzazioni AS 
            SELECT utl_automezzo.id AS ref_id, utl_automezzo.targa AS ref_identifier, 'automezzo' AS tipologia_risorsa, utl_automezzo.engaged AS ref_engaged,
                ...
                WHERE utl_automezzo.disponibilita::integer = 1
                AND vol_organizzazione.stato_iscrizione::integer = 3
                UNION
                ...
                AND utl_attrezzatura.disponibilita::integer = 1
                AND vol_organizzazione.stato_iscrizione::integer = 3
                UNION
                ...
                LEFT JOIN loc_comune ON loc_comune.id = vol_sede.comune
                LEFT JOIN loc_provincia ON loc_provincia.id = loc_comune.id_provincia
                WHERE vol_organizzazione.stato_iscrizione::integer = 3
        ")
        ->execute();
    ...
    {
        VolOrganizzazione::updateAll(['stato_iscrizione' => 0], 'id_sync is null or id_sync = \'\'');
        UtlAutomezzo::updateAll(['disponibilita' => 0], 'id_sync is null or id_sync = \'\'');
        ...
        $this->dropColumn("utl_attrezzatura","disponibilita");
    }
    ...
    {
        echo "m181116_182222_sync_alter_data_for_inevitable_errors_cause_by_publishing_fluxes cannot be reverted.\n";
