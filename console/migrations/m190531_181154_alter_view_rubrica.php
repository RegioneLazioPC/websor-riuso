...
/**
 * Class m190531_181154_alter_view_rubrica
 */
class m190531_181154_alter_view_rubrica extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        Yii::$app->db->createCommand("CREATE OR REPLACE VIEW view_rubrica as
            SELECT 
            id_contatto,
            valore_contatto,
            use_type, 
    ...
    {
        echo "m190531_181154_alter_view_rubrica cannot be reverted.\n";
