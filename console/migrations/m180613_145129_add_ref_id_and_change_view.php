...
/**
 * Class m180613_145129_add_ref_id_and_change_view
 */
class m180613_145129_add_ref_id_and_change_view extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $this->addColumn('vol_organizzazione', 'nome_referente', $this->string());
        $this->addColumn('vol_organizzazione', 'tel_referente', $this->string());
        $this->addColumn('vol_organizzazione', 'fax_referente', $this->string());
        $this->addColumn('vol_organizzazione', 'email_referente', $this->string());
        ...
        Yii::$app->db->createCommand("CREATE VIEW view_organizzazioni AS 
            SELECT utl_automezzo.id AS ref_id, utl_automezzo.targa AS ref_identifier, 'automezzo' AS tipologia_risorsa, utl_automezzo.engaged AS ref_engaged,
                ...
                vol_organizzazione.pec_responsabile, vol_organizzazione.tel_responsabile, vol_organizzazione.email_responsabile, vol_organizzazione.nome_responsabile,
                    vol_organizzazione.ref_id as codice_associazione, vol_organizzazione.tel_referente
                FROM utl_automezzo 
    ...
    {
        $this->dropColumn('vol_organizzazione', 'nome_referente');
        $this->dropColumn('vol_organizzazione', 'tel_referente');
        $this->dropColumn('vol_organizzazione', 'fax_referente');
        $this->dropColumn('vol_organizzazione', 'email_referente');
    ...
    {
        echo "m180613_145129_add_ref_id_and_change_view cannot be reverted.\n";
