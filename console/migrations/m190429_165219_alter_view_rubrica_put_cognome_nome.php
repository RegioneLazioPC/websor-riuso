...
/**
 * Class m190429_165219_alter_view_rubrica_put_cognome_nome
 */
class m190429_165219_alter_view_rubrica_put_cognome_nome extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        Yii::$app->db->createCommand("CREATE VIEW view_rubrica as
            ...
            utl_contatto.use_type as use_type,
            ...
            utl_contatto.check_predefinito as check_predefinito,
            'utl_contatto' as contatto_type,
            CONCAT(utl_anagrafica.cognome, ' ', utl_anagrafica.nome) as valore_riferimento,
            utl_contatto.type as tipo_contatto,
            ...
            LEFT JOIN loc_comune on loc_comune.id = utl_indirizzo.id_comune
            LEFT JOIN loc_provincia on loc_provincia.id = loc_comune.id_provincia
            WHERE utl_contatto.id is not null AND utl_contatto.\"type\" = 6;"
        )->execute();
    }
    ...
    {
        echo "m190429_165219_alter_view_rubrica_put_cognome_nome cannot be reverted.\n";
