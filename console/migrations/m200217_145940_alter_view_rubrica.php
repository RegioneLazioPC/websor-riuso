...
/**
 * Class m200217_145940_alter_view_rubrica
 */
class m200217_145940_alter_view_rubrica extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        Yii::$app->db->createCommand("
            DROP VIEW view_rubrica
            ")->execute();

        Yii::$app->db->createCommand("
            CREATE VIEW view_rubrica AS 
            SELECT  t.id_contatto,
                   ...
                   FROM ( SELECT DISTINCT ON (con_struttura_contatto.id) con_struttura_contatto.id_contatto,
                            ...
                            utl_contatto.vendor,
                            str_struttura.zone_allerta as zone_allerta,
                            null::int as num_elenco_territoriale
                        ...
                        UNION ALL
                         SELECT DISTINCT ON (con_ente_contatto.id) con_ente_contatto.id_contatto,
                            ...
                            'ente'::text AS entita,
                            utl_contatto.vendor,
                            ent_ente.zone_allerta as zone_allerta,
                            null::int as num_elenco_territoriale
                        ...
                        UNION ALL
                         SELECT DISTINCT ON (con_organizzazione_contatto.id) con_organizzazione_contatto.id_contatto,
                            ...
                            utl_contatto.vendor,
                            vol_organizzazione.zone_allerta as zone_allerta,
                            vol_organizzazione.ref_id::int as num_elenco_territoriale
                     ...
                     LEFT JOIN con_rubrica_group_contact ON con_rubrica_group_contact.id_rubrica_contatto = id_riferimento AND con_rubrica_group_contact.tipo_rubrica_contatto = tipo_riferimento
                     LEFT JOIN rubrica_group ON rubrica_group.id = con_rubrica_group_contact.id_group
                      GROUP BY t.id_contatto,
                    t.valore_contatto,
                    t.use_type,
                    t.check_mobile,
                    t.check_predefinito,
                    ...
                    con_view_rubrica_everbridge_ext_ids.delivery_path;
            ")->execute();
    }
    ...
    {
        echo "m200217_145940_alter_view_rubrica cannot be reverted.\n";
