...
$this->title = 'Lista Veicoli attivi';
...
<div class="utl-evento-index">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'before' => Html::a('<i class="glyphicon glyphicon-repeat"></i> Azzera filtri', ['vehicles'], ['class' => 'btn btn-info m10w']),
        ],
        'columns' => [
            [
                'label' => 'Incident',
                ...
                'value' => function($data) {
                    try {
                        ...
                        foreach ($data->segnalazioni as $segnalazione) {
                            if(!empty($segnalazione->evento)) $evts[] = $segnalazione->evento->num_protocollo;
                        }
