    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($data){
                    ...
                    if($data->stato != 'Chiuso') {
                        ...
                        if( intval($diff) > 1) $icons .= '<span class="fas fa-exclamation-triangle m5w text-danger" title="Da gestire" data-toggle="tooltip"></span>';
                    }
                    ...
                    if(!empty($data->richiesteElicottero)){
                        ...
                        $eli = $data->getRichiesteElicottero()->asArray()->all();
                        $eli_ok = 0;
                        $eli_ko = 0;
                        $eli_to_approve = 0;
                        $total = 0;
                        ...
                        $color = 'default';
                        if( ($eli_ok > 0 || $eli_ko > 0) && $eli_to_approve > 0 ) $color = 'lemon';
            ...
            [
                ...
                'template' => '{view} {update} {task} {public}',
                'buttons' => [
