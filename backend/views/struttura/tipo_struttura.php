...
$cols = [
    ...
    [
        ...
        'template' => '{view-tipo-struttura} {update-tipo-struttura}',
        'buttons' => [
            'view-tipo-struttura' => function ($url, $model) {
                if(Yii::$app->user->can('Admin')){
                    return Html::a('<span class="fa fa-eye"></span>&nbsp;&nbsp;', $url, [
                        'title' => Yii::t('app', 'Dettaglio tipo struttura'),
                        'data-toggle'=>'tooltip'
                    ]) ;
                }else{
                    return '';
            ...
            'update-tipo-struttura' => function ($url, $model) {
                if(Yii::$app->user->can('Admin')){
                    return Html::a('<span class="fa fa-pencil"></span>&nbsp;&nbsp;', $url, [
                        'title' => Yii::t('app', 'Modifica tipo struttura'),
                        'data-toggle'=>'tooltip'
                    ]) ;
                }else{
                    return '';
