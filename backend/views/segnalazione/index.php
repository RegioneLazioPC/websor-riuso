...
$cols = [
            ...
            [
                ...
                'filter'=> Html::activeDropDownList($searchModel, 'ruolo_segnalatore', ArrayHelper::map(UtlRuoloSegnalatore::find()->asArray()->all(), 'id', 'descrizione'), ['class' => 'form-control','prompt' => 'Tutti']),
                'value' => function($data){
