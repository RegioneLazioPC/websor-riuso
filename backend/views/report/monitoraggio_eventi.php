...
$this->title = 'Monitoraggio eventi';
...
<div class="utl-evento-index">
        ...
        $cols = [
            ...
            [
                ...
                'value' => function($data) {
                    return implode("<br />", array_map(function($elicottero){
                        return "<b>CODICE:</b> " . $elicottero['codice'] . " " . $elicottero['elicottero'] ;
                    }, $data['elicotteri']));
                }
            ],
            [
                ...
                'value' => function($data) {
                    return implode("<br />", array_map(function($canadair){
                        return "<b>CODICE:</b> " . $canadair['codice'] ;
                    }, $data['canadair']));
                }
            ],
            [
            ...
            [
                ...
                'value' => function($data) {
                    return implode("<br />", array_map(function($a){
                        return "<b>MESSAGGIO CAP:</b> " . $a['cap_identifier'] . " ".$a['targa']." ".$a['modello'];
                    }, $data['veicoli_cap']));
                }
            ],     
        ];
        ...
        ?>
        <h4 style="margin-bottom: 18px;">Monitoraggio eventi</h4>
