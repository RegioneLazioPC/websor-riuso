...
$sottotipologie = (!empty($ingaggiSearchModel->tipologia)) ? 
            ArrayHelper::map(
                ...
                ->orderBy(['idparent'=>SORT_ASC])->asArray()->all(), 'tipologia', 'tipologia') 
            : [];
...
$cols = [
            ...
            [
                ...
                'format' => 'raw',
                'contentOptions' => ['style'=>'width: 80px;'],
                'filter'=> Html::activeDropDownList($ingaggiSearchModel, 'tipologia', 
                    array_merge( ['__'=>'Sos'], ArrayHelper::map(UtlTipologia::find()->where('idparent is null')->asArray()->all(), 'tipologia', 'tipologia')), ['class' => 'form-control','prompt' => 'Tutti'])
            ],
            [
                ...
                'format' => 'raw',
                'contentOptions' => ['style'=>'width: 80px;'],
                'filter'=> Html::activeDropDownList($ingaggiSearchModel, 'sottotipologia', 
                    $sottotipologie, ['class' => 'form-control','prompt' => 'Tutti'])
            ],
            [
                'label' => 'Gestore',
            ...
            [
                ...
                'filter'=> Html::activeDropDownList($ingaggiSearchModel, 'tipo_automezzo', ArrayHelper::map(UtlAutomezzoTipo::find()->all(), 'id', 'descrizione'), 
            ...
            [
                ...
                'filter'=> Html::activeDropDownList($ingaggiSearchModel, 'tipo_attrezzatura', ArrayHelper::map(UtlAttrezzaturaTipo::find()->all(), 'id', 'descrizione'), 
                    ['class' => 'form-control','prompt' => 'Tutti']),
